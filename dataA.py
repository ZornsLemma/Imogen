...
comment(0x3e8d, "Yes. Is the player colliding with solid rock? (We probably 'should' only check for collision below, but in practice the other directions aren't possible.)")
...
expr(0x40e8, "baby_spriteid_data_entries_minus_1")
expr(0x4101, "baby_spriteid_data_entries_minus_1")
...
constant(0xd, "another_specific_baby_spriteid_index_entry")
expr(0x415f, "another_specific_baby_spriteid_index_entry")
constant(0x19, "yet_another_specific_baby_spriteid_index_entry")
expr(0x4147, "yet_another_specific_baby_spriteid_index_entry")
expr(0x4157, "baby_spriteid_data_entries_minus_1")
