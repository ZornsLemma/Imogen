...
comment(0x3e7d, "Yes. Is the player standing over the trapdoor? TODO: Do we check the player's Y coordinate? (The wizard can jump - does the trapdoor trigger even if the wizard is in the air?")
