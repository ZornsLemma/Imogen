...
label(0x0a30, "save_game_j_got_cannonball_progress")
label(0x0a31, "save_game_j_room_0_babboon_animation")
label(0x0a32, "save_game_j_partition_progress")
...
label(0x0a77, "babboon_animation_step")
label(0x0a78, "babboon_y_low")
label(0x0a79, "cannonball_throw_animation_step")
