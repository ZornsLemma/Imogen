...
byte(0x3fb1)
label(0x3fb2, "gorilla_animation4")
...
byte(0x3fc4, 3)
byte(0x3fc7)
label(0x3fc8, "gorilla_animation5")
expr(0x3fc8, sprite_dict)
byte(0x3fcb)
label(0x3fcc, "gorilla_animation6")
