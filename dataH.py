...
expr(0x3f54, "object_x_low + 3")
expr(0x3ffa, "object_spriteid + 3")
expr(0x4000, "object_x_low + 3")
expr(0x4006, "object_direction + 3")
expr(0x43b2, "object_spriteid + 2")
expr(0x43ba, "object_x_low + 2")
expr(0x43c0, "object_x_high + 2")
expr(0x43c6, "object_y_low + 2")
expr(0x43cc, "object_y_high + 2")
expr(0x43d1, "object_spriteid + 2")
