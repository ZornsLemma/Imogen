...
byte(0x40ba, 2)
byte(0x40bc)
label(0x40bd, "fruit_animation2")
byte(0x40bd, 2)
byte(0x40bf, 2)
byte(0x40c1, 2)
byte(0x40c3, 2)
byte(0x40c5)
label(0x40c6, "fruit_animation3")
byte(0x40c6, 2)
byte(0x40c8)
label(0x40c9, "fruit_animation4")
byte(0x40c9, 2)
byte(0x40cb)
label(0x40cc, "fruit_animation5")
byte(0x40cc, 2)
byte(0x40ce, 2)
byte(0x40d0, 2)
byte(0x40d2)
label(0x40d3, "fruit_animation6")
byte(0x40d3, 2)
byte(0x40d5)
...
expr(0x40f4, "fruit_animation3 - fruit_animation_base")
...
expr(0x41c2, "rabbit_walk_end_sprites - rabbit_sprites_base")
expr(0x41c9, "fruit_animation4 - fruit_animation_base")
expr(0x41d3, "objectid_fruit")
label(0x41d9, "end_of_walk_sound")
expr(0x41dc, make_lo("sound1"))
expr(0x41de, make_hi("sound1"))
label(0x41e5, "play_landing_sound_local")
expr(0x41e9, "fruit_animation6 - fruit_animation_base")
...
expr(0x435b, "fruit_animation6 - fruit_animation_base")
expr(0x435f, "fruit_animation4 - fruit_animation_base")
...
expr(0x43de, "fruit_animation3 - fruit_animation_base")
