...
label(0x4226, "parrot_squawk_spriteids")
...
comment(0x42e5, "divide to difference by eight to get a cell distance")
comment(0x42f2, "increment animation step, loop back to start of animation if at end")
label(0x42fe, "skip1")
...
expr(0x43c6, "parrot_squawk_spriteids - parrot_spriteid_table")
