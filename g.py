...
expr(0x334b, make_hi("some_more_data2"))
...
label(0x2ced, "wizard_animations")
expr(0x2d8d, make_lo("wizard_animations"))
expr(0x2d8f, make_hi("wizard_animations"))

label(0x2f16, "cat_animations")
expr(0x2fce, make_lo("cat_animations"))
expr(0x2fd0, make_hi("cat_animations"))

label(0x30ff, "monkey_animations")
expr(0x31de, make_lo("monkey_animations"))
expr(0x31e0, make_hi("monkey_animations"))

expr(0x2e86, make_lo("wizard_animations"))
expr(0x2e88, make_hi("wizard_animations"))

label(0x2cd7, "wizard_animations2")
expr(0x2ebd, make_lo("wizard_animations2"))
expr(0x2ebf, make_hi("wizard_animations2"))

expr(0x30aa, make_lo("cat_animations"))
expr(0x30ac, make_hi("cat_animations"))

label(0x2f00, "cat_animations2")
expr(0x30d6, make_lo("cat_animations2"))
expr(0x30d8, make_hi("cat_animations2"))

expr(0x333b, make_lo("monkey_animations"))
expr(0x333d, make_hi("monkey_animations"))

label(0x30e6, "monkey_animations2")
expr(0x3367, make_lo("monkey_animations2"))
expr(0x3369, make_hi("monkey_animations2"))
