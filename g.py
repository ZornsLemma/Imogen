...
expr(0x2daf, "wizard_animation9 - wizard_animation2")
expr(0x2dc4, "wizard_animation14 - wizard_animation2")
expr(0x2dc9, "wizard_animation10 - wizard_animation2")
expr(0x2dbd, "wizard_animation9 - wizard_animation2")
expr(0x2dd3, "wizard_animation14 - wizard_animation2")
expr(0x2de5, "wizard_animation14 - wizard_animation2")
expr(0x2df9, "wizard_animation5 - wizard_animation2")
expr(0x2e00, "wizard_animation4 - wizard_animation2")
expr(0x2e0a, "wizard_animation14 - wizard_animation2")
expr(0x2e0e, "wizard_animation9 - wizard_animation2")
expr(0x2e1f, "wizard_animation7 - wizard_animation2")
expr(0x2e24, "wizard_animation4 - wizard_animation2")
expr(0x2e28, "wizard_animation5 - wizard_animation2")
expr(0x2e35, "wizard_animation8 - wizard_animation2")
expr(0x2e43, "wizard_animation6 - wizard_animation2")
expr(0x2e52, "wizard_animation14 - wizard_animation2")
expr(0x2e57, "wizard_animation11 - wizard_animation2")
expr(0x2e5e, "wizard_animation12 - wizard_animation2")
label(0x09df, "current_animation")
expr(0x2ea9, "spriteid_wizard6")

expr(0x3203, "monkey_animation11 - monkey_animation2")
expr(0x3207, "monkey_animation9 - monkey_animation2")
expr(0x320b, "monkey_animation8 - monkey_animation2")
expr(0x3219, "monkey_animation11 - monkey_animation2")
expr(0x321e, "monkey_animation10 - monkey_animation2")
expr(0x3239, "monkey_animation11 - monkey_animation2")
expr(0x3248, "monkey_animation8 - monkey_animation2")
expr(0x324d, "monkey_animation12 - monkey_animation2")
expr(0x3257, "monkey_animation9 - monkey_animation2")
expr(0x3260, "monkey_animation19 - monkey_animation2")
expr(0x327a, "monkey_animation13 - monkey_animation2")
expr(0x3288, "monkey_animation13 - monkey_animation2")
expr(0x3291, "monkey_animation14 - monkey_animation2")
expr(0x329f, "monkey_animation14 - monkey_animation2")
expr(0x32a6, "monkey_animation19 - monkey_animation2")
expr(0x32ab, "monkey_animation15 - monkey_animation2")
expr(0x32b2, "monkey_animation19 - monkey_animation2")
expr(0x32bf, "monkey_animation18 - monkey_animation2")
expr(0x32c1, "monkey_animation9 - monkey_animation2")
expr(0x32d6, "monkey_animation19 - monkey_animation2")
expr(0x32da, "monkey_animation13 - monkey_animation2")
expr(0x32df, "monkey_animation5 - monkey_animation2")
expr(0x32e6, "monkey_animation4 - monkey_animation2")
expr(0x32f0, "monkey_animation19 - monkey_animation2")
expr(0x32f4, "monkey_animation14 - monkey_animation2")
expr(0x3305, "monkey_animation7 - monkey_animation2")
expr(0x330a, "monkey_animation4 - monkey_animation2")
expr(0x330e, "monkey_animation5 - monkey_animation2")
expr(0x3312, "monkey_animation6 - monkey_animation2")
expr(0x3324, "monkey_animation19 - monkey_animation2")
expr(0x3329, "monkey_animation16 - monkey_animation2")
expr(0x3330, "monkey_animation17 - monkey_animation2")
...
label(0x3115, "monkey_animation3")
label(0x3128, "monkey_animation4")
label(0x3135, "monkey_animation5")
label(0x313c, "monkey_animation6")
label(0x3140, "monkey_animation7")
label(0x3144, "monkey_animation8")
label(0x3148, "monkey_animation9")
label(0x314c, "monkey_animation10")
label(0x3150, "monkey_animation11")
label(0x3157, "monkey_animation12")
label(0x3179, "monkey_animation13")
label(0x3186, "monkey_animation14")
...
label(0x31d3, "monkey_animation19")
...
label(0x2ced, "wizard_animation2")
expr(0x2d8d, make_lo("wizard_animation2"))
expr(0x2d8f, make_hi("wizard_animation2"))
label(0x2d03, "wizard_animation3")
label(0x2d16, "wizard_animation4")
label(0x2d23, "wizard_animation5")
label(0x2d2a, "wizard_animation6")
label(0x2d2e, "wizard_animation7")
label(0x2d32, "wizard_animation8")
label(0x2d36, "wizard_animation9")
...
label(0x2d83, "wizard_animation14")

label(0x2f16, "cat_animation2")
expr(0x2fce, make_lo("cat_animation2"))
expr(0x2fd0, make_hi("cat_animation2"))

label(0x2f2c, "cat_animation3")
label(0x2f3f, "cat_animation4")
label(0x2f4c, "cat_animation5")
label(0x2f53, "cat_animation6")
label(0x2f57, "cat_animation7")
label(0x2f5b, "cat_animation8")
label(0x2f6e, "cat_animation9")
label(0x2f75, "cat_animation10")
label(0x2f9a, "cat_animation11")
label(0x2fa7, "cat_animation12")
label(0x2fb4, "cat_animation13")
label(0x2fc4, "cat_animation14")

expr(0x2ff0, "cat_animation8 - cat_animation2")
expr(0x2ffe, "cat_animation8 - cat_animation2")
expr(0x300a, "cat_animation9 - cat_animation2")
expr(0x3012, "cat_animation9 - cat_animation2")
expr(0x3020, "cat_animation9 - cat_animation2")
expr(0x3029, "cat_animation10 - cat_animation2")
expr(0x3033, "cat_animation14 - cat_animation2")
expr(0x3045, "cat_animation14 - cat_animation2")
expr(0x304f, "cat_animation13 - cat_animation2")
expr(0x3059, "cat_animation5 - cat_animation2")
expr(0x3060, "cat_animation4 - cat_animation2")
expr(0x3067, "cat_animation8 - cat_animation2")
expr(0x3078, "cat_animation7 - cat_animation2")
expr(0x307c, "cat_animation7 - cat_animation2")
expr(0x3081, "cat_animation4 - cat_animation2")
expr(0x3085, "cat_animation5 - cat_animation2")
expr(0x3089, "cat_animation6 - cat_animation2")
expr(0x3098, "cat_animation14 - cat_animation2")
expr(0x309d, "cat_animation11 - cat_animation2")
expr(0x30a4, "cat_animation12 - cat_animation2")
...
label(0x30ff, "monkey_animation2")
expr(0x31de, make_lo("monkey_animation2"))
expr(0x31e0, make_hi("monkey_animation2"))

expr(0x2e86, make_lo("wizard_animation2"))
expr(0x2e88, make_hi("wizard_animation2"))

label(0x2cd7, "wizard_animation1")
expr(0x2ebd, make_lo("wizard_animation1"))
expr(0x2ebf, make_hi("wizard_animation1"))

expr(0x30aa, make_lo("cat_animation2"))
expr(0x30ac, make_hi("cat_animation2"))

label(0x2f00, "cat_animation1")
expr(0x30d6, make_lo("cat_animation1"))
expr(0x30d8, make_hi("cat_animation1"))

expr(0x333b, make_lo("monkey_animation2"))
expr(0x333d, make_hi("monkey_animation2"))
