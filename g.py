...
label(0x38a4, "yet_more_data1")
expr(0x2b0e, make_lo("yet_more_data1"))
expr(0x2b10, make_hi("yet_more_data1"))

label(0x38d0, "yet_more_data2")
expr(0x234a, make_lo("yet_more_data2"))
expr(0x234c, make_hi("yet_more_data2"))

label(0x38ba, "yet_more_data3")
expr(0x2351, make_lo("yet_more_data3"))
expr(0x2353, make_hi("yet_more_data3"))

label(0x38ee, "yet_more_data4")
expr(0x23b1, make_lo("yet_more_data4"))
expr(0x23b3, make_hi("yet_more_data4"))

label(0x38e6, "yet_more_data5")
expr(0x23b8, make_lo("yet_more_data5"))
expr(0x23ba, make_hi("yet_more_data5"))
