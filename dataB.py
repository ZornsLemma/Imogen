...
label(0x0a07, "room_2_falling_rock_progress")   # 0: suspended, 1+: falling, $ff: finished falling
label(0x0a08, "room_0_falling_rock_progress")
...
label(0x41c1, "play_rock_landing_sounds")
...
comment(0x41e6, "new level, finish any falling rock progress immediately")
label(0x41f0, "room_2_update_suspended_boulder")
comment(0x41f7, "draw rope above boulder")
label(0x42d8, "falling_rock_progress")
