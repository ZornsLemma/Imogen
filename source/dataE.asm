...
c3cd3
    lda l0070                                                         ; 3cd3: a5 70
    and #4                                                            ; 3cd5: 29 04
    beq loop_c3cc3                                                    ; 3cd7: f0 ea
    ldx #1                                                            ; 3cd9: a2 01
...
loop_c414c
    ...
    lda l0a6f                                                         ; 4153: ad 6f 0a
    beq c4166                                                         ; 4156: f0 0e
    dec l0a6f                                                         ; 4158: ce 6f 0a
    ldx #2                                                            ; 415b: a2 02
...
c416e
    ...
    lda l0a6f                                                         ; 418a: ad 6f 0a
    bmi c4192                                                         ; 418d: 30 03
    inc l0a6f                                                         ; 418f: ee 6f 0a
c4192
...
c443f
    lda l0070                                                         ; 443f: a5 70
    and #4                                                            ; 4441: 29 04
    beq loop_c442f                                                    ; 4443: f0 ea
    ldx #0                                                            ; 4445: a2 00
