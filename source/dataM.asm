...
level_specific_update
    jsr sub_c4539                                                     ; 3b11: 20 39 45
    jsr sub_c3de6                                                     ; 3b14: 20 e6 3d
    jsr sub_c3cb5                                                     ; 3b17: 20 b5 3c
    jsr sub_c41de                                                     ; 3b1a: 20 de 41
...
loop_c3c59
    ...
    sta l0070                                                         ; 3c5c: 85 70
    and #1                                                            ; 3c5e: 29 01
    beq c3c69                                                         ; 3c60: f0 07
    ldx #0                                                            ; 3c62: a2 00
    ldy current_level                                                 ; 3c64: a4 31
    jmp initialise_level_and_room                                     ; 3c66: 4c 40 11

c3c69
    lda l0070                                                         ; 3c69: a5 70
    and #4                                                            ; 3c6b: 29 04
    beq loop_c3c59                                                    ; 3c6d: f0 ea
    ldx #2                                                            ; 3c6f: a2 02
...
c3dac
    ...
    cmp #1                                                            ; 3dae: c9 01
    bne c3de5                                                         ; 3db0: d0 33
    lda l0a71                                                         ; 3db2: ad 71 0a
    sta l0955                                                         ; 3db5: 8d 55 09
    sta l0957                                                         ; 3db8: 8d 57 09
    lda l0a72                                                         ; 3dbb: ad 72 0a
    sta l0981                                                         ; 3dbe: 8d 81 09
    sta l0983                                                         ; 3dc1: 8d 83 09
    lda l0a73                                                         ; 3dc4: ad 73 0a
    sta l09c3                                                         ; 3dc7: 8d c3 09
    sta l09c5                                                         ; 3dca: 8d c5 09
    ...
    ldx #$e4                                                          ; 3ddd: a2 e4
c3ddf
    sta l09ad                                                         ; 3ddf: 8d ad 09
    stx l09af                                                         ; 3de2: 8e af 09
c3de5
    rts                                                               ; 3de5: 60
...
loop_c3e4c
    ...
    ldx #$10                                                          ; 3e65: a2 10
    lda l0a6f                                                         ; 3e67: ad 6f 0a
    and #4                                                            ; 3e6a: 29 04
    beq c3e7d                                                         ; 3e6c: f0 0f
    lda l0a6f                                                         ; 3e6e: ad 6f 0a
    sec                                                               ; 3e71: 38
    sbc #$0c                                                          ; 3e72: e9 0c
    lsr                                                               ; 3e74: 4a
    lsr                                                               ; 3e75: 4a
...
c3f03
    ...
    lda object_y_low+1                                                ; 3f13: ad 7d 09
    clc                                                               ; 3f16: 18
    adc #4                                                            ; 3f17: 69 04
    sta object_y_low+1                                                ; 3f19: 8d 7d 09
    lda l0a6f                                                         ; 3f1c: ad 6f 0a
    sec                                                               ; 3f1f: 38
    sbc #4                                                            ; 3f20: e9 04
    sta l0a6f                                                         ; 3f22: 8d 6f 0a
    lda desired_room_index                                            ; 3f25: a5 30
    cmp #1                                                            ; 3f27: c9 01
    bne c3ed0                                                         ; 3f29: d0 a5
    jsr sub_c401a                                                     ; 3f2b: 20 1a 40
    lda #$e2                                                          ; 3f2e: a9 e2
    sta l09b7                                                         ; 3f30: 8d b7 09
    sta l09ac                                                         ; 3f33: 8d ac 09
    lda #0                                                            ; 3f36: a9 00
    sta l09b5                                                         ; 3f38: 8d b5 09
    jmp c3fe8                                                         ; 3f3b: 4c e8 3f

c3f3e
    lda l0a6f                                                         ; 3f3e: ad 6f 0a
    cmp #$50 ; 'P'                                                    ; 3f41: c9 50
...
c3f55
    ...
    lda #0                                                            ; 3f64: a9 00
    sta l09b7                                                         ; 3f66: 8d b7 09
    lda #$e3                                                          ; 3f69: a9 e3
    sta l09ac                                                         ; 3f6b: 8d ac 09
    lda #0                                                            ; 3f6e: a9 00
    sta l09b5                                                         ; 3f70: 8d b5 09
c3f73
    lda l0a6f                                                         ; 3f73: ad 6f 0a
    cmp #$50 ; 'P'                                                    ; 3f76: c9 50
...
c4081
    lda #$40 ; '@'                                                    ; 4081: a9 40
    sta l0956                                                         ; 4083: 8d 56 09
    lda #0                                                            ; 4086: a9 00
    sta l096c                                                         ; 4088: 8d 6c 09
    sta l09ae                                                         ; 408b: 8d ae 09
    lda #1                                                            ; 408e: a9 01
    sta l09c4                                                         ; 4090: 8d c4 09
    ...
    sta l0982                                                         ; 40b5: 8d 82 09
    lda #$dc                                                          ; 40b8: a9 dc
    sta l09ae                                                         ; 40ba: 8d ae 09
    lda #0                                                            ; 40bd: a9 00
    sta l09b9                                                         ; 40bf: 8d b9 09
    jmp c40e6                                                         ; 40c2: 4c e6 40

c40c5
    tay                                                               ; 40c5: a8
    lda l4023,y                                                       ; 40c6: b9 23 40
    sta l09ae                                                         ; 40c9: 8d ae 09
    lda #$38 ; '8'                                                    ; 40cc: a9 38
    sta l0982                                                         ; 40ce: 8d 82 09
    lda l09ae                                                         ; 40d1: ad ae 09
    cmp l09b9                                                         ; 40d4: cd b9 09
    bne c40e1                                                         ; 40d7: d0 08
    lda l0982                                                         ; 40d9: ad 82 09
    cmp l098d                                                         ; 40dc: cd 8d 09
    beq c40e6                                                         ; 40df: f0 05
c40e1
    lda #0                                                            ; 40e1: a9 00
    sta l09b9                                                         ; 40e3: 8d b9 09
c40e6
    lda l0982                                                         ; 40e6: ad 82 09
    cmp #$89                                                          ; 40e9: c9 89
...
c411c
    ...
    bne c412d                                                         ; 411f: d0 0c
    lda l0a49                                                         ; 4121: ad 49 0a
    beq c412d                                                         ; 4124: f0 07
    cmp #$45 ; 'E'                                                    ; 4126: c9 45
    beq c412d                                                         ; 4128: f0 03
...
loop_c41a9
    ...
    sta l0070                                                         ; 41ac: 85 70
    and #1                                                            ; 41ae: 29 01
    beq c41b9                                                         ; 41b0: f0 07
    ldx #1                                                            ; 41b2: a2 01
    ldy current_level                                                 ; 41b4: a4 31
    jmp initialise_level_and_room                                     ; 41b6: 4c 40 11

c41b9
    lda l0070                                                         ; 41b9: a5 70
    and #4                                                            ; 41bb: 29 04
    beq loop_c41a9                                                    ; 41bd: f0 ea
    ldx #3                                                            ; 41bf: a2 03
...
c4200
    ...
    sta five_byte_table_paired_with_collectable_sprite_ids + 1        ; 420a: 8d f3 2e
...
c426d
    lda #0                                                            ; 426d: a9 00
    sta l09b9                                                         ; 426f: 8d b9 09
c4272
    jmp c4370                                                         ; 4272: 4c 70 43
...
c429c
    ...
    lda object_x_low+1                                                ; 42b9: ad 51 09
    sta l0a42                                                         ; 42bc: 8d 42 0a
    lda object_x_high+1                                               ; 42bf: ad 67 09
    sta l0a43                                                         ; 42c2: 8d 43 0a
    lda object_y_low+1                                                ; 42c5: ad 7d 09
...
c4313
    lda #0                                                            ; 4313: a9 00
    sta l09ae                                                         ; 4315: 8d ae 09
    lda #$ff                                                          ; 4318: a9 ff
    sta l0a40                                                         ; 431a: 8d 40 0a
    jmp c4370                                                         ; 431d: 4c 70 43
...
c4356
    lda l0982                                                         ; 4356: ad 82 09
    cmp l098d                                                         ; 4359: cd 8d 09
    beq c4370                                                         ; 435c: f0 12
...
sub_c4480
    ...
    sta l0956                                                         ; 448d: 8d 56 09
    lda l0a43                                                         ; 4490: ad 43 0a
    sta l096c                                                         ; 4493: 8d 6c 09
    lda l0a44                                                         ; 4496: ad 44 0a
    sta l0982                                                         ; 4499: 8d 82 09
    lda #$d9                                                          ; 449c: a9 d9
    sta l09ae                                                         ; 449e: 8d ae 09
    lda l0a45                                                         ; 44a1: ad 45 0a
    sta l09c4                                                         ; 44a4: 8d c4 09
    rts                                                               ; 44a7: 60
...
sub_c4539
    ...
    !byte   5,   1,   0,   0,   0,   0,   0,   0, $0a,   0,   0, $d8  ; 4547: 05 01 00...
    !byte $28,   0, $10,   0,   5,   0,   4,   0,   4,   0,   6,   1  ; 4553: 28 00 10...
    !byte   0,   0,   0,   0,   0,   0, $37,   0,   0, $fa, $6e, $37  ; 455f: 00 00 00...
    !byte $10,   0,   6,   0,   7,   0,   1,   0, $11,   0,   0,   0  ; 456b: 10 00 06...
    !byte $d2,   0,   1,   0,   7,   2,   0,   0,   0,   0,   0,   0  ; 4577: d2 00 01...
    !byte $78,   0, $f6, $f6, $78,   0, $10,   0,   7,   0,   3,   0  ; 4583: 78 00 f6...
    !byte   2,   0,   8, $82, $fc, $fe, $ff, $14, $28, $50,   0,   0  ; 458f: 02 00 08...
    !byte   0,   0,   0,   0, $11,   0,   8,   0, $80,   0,   2,   0  ; 459b: 00 00 00...
