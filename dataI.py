...
label(0x38b4, "object_erase_type + objectid_rope_end")
...
expr(0x3e1b, "object_spriteid + objectid_rope_end")
expr(0x3e48, sprite_dict)
expr(0x3e4d, sprite_dict)
expr(0x3e4f, "object_spriteid + objectid_rope_end")
