...
constant(0x21, "spriteid_menu_item_completion_spell")
...
expr(0x53d9, "vdu_cr")
comment(0x53e3, "At this point we have the level pointer for the successfully matched password in YX")
...
label(0x55d3, "set_up_break_effects")
label(0x5625, "mark_all_levels_complete_loop")
...
label(0x5635, "return_a_one")
expr(0x5631, "spriteid_menu_item_completion_spell")
label(0x564e, "screen_dump_to_epson_printer")
...
comment(0x552e, "Some intriguing secret passwords here. The Micro User printed these (See https://archive.org/details/micro-user-058/page/n52/mode/1up), but still cool to find them for myself. :-)")
