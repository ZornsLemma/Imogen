...
bird_step(0x3b9e)
term(0x3ba2)
label(0x3ba3, "bird_turn2_animation")
bird_step(0x3ba3)
label(0x3ba7, "bird_turn2_mid_way")
bird_step(0x3ba7)
term(0x3bab)
label(0x3bac, "bird_start_fall_animation")
bird_step(0x3bac)
bird_step(0x3bb0)
term(0x3bb4)
...
expr(0x3ecd, "bird_turn2_mid_way - bird_base_animations")
...
expr(0x3f02, "bird_turn2_animation - bird_base_animations")
...
expr(0x3f41, "bird_start_fall_animation - bird_base_animations")
expr(0x3f48, "objectid_player")
expr(0x3f4f, "bird_start_fall_animation - bird_base_animations")
...
expr(0x3f86, "bird_start_fall_animation - bird_base_animations")    #$66
expr(0x3f88, "bird_start_fall_animation - bird_base_animations")    #$66
