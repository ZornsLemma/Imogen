...
# 'make game' takes the source files and creates binary files from them in the /disk directory. It checks the newly made binaries match the originals. Creates an ssd from the binaries too.
...
source/g.asm: g.py common.py orig/g.dat
	python3 g.py --acme > build/g_temp.asm
	cp build/g_temp.asm source/g.asm
	rm build/g_temp.asm

source/auxcode.asm: auxcode.py common.py orig/auxcode.dat
...
disk/icodata: encoder.py source/icodata.txt
	python3 encoder.py -i source/icodata.txt -o disk/icodata

disk/sprdata: encoder.py source/sprdata.txt
...
disk/dataB: encoder.py source/dataB.asm source/levelB.txt
...
disk/dataC: encoder.py source/dataC.asm source/levelC.txt
...
disk/dataD: encoder.py source/dataD.asm source/levelD.txt
...
disk/dataE: encoder.py source/dataE.asm source/levelE.txt
...
disk/dataF: encoder.py source/dataF.asm source/levelF.txt
...
disk/dataG: encoder.py source/dataG.asm source/levelG.txt
...
disk/dataH: encoder.py source/dataH.asm source/levelH.txt
...
disk/dataI: encoder.py source/dataI.asm source/levelI.txt
...
disk/dataJ: encoder.py source/dataJ.asm source/levelJ.txt
...
disk/dataK: encoder.py source/dataK.asm source/levelK.txt
...
disk/dataL: encoder.py source/dataL.asm source/levelL.txt
...
disk/dataM: encoder.py source/dataM.asm source/levelM.txt
...
disk/dataN: encoder.py source/dataN.asm source/levelN.txt
...
disk/dataO: encoder.py source/dataO.asm source/levelO.txt
...
disk/dataP: encoder.py source/dataP.asm source/levelP.txt
...
disk/dataQ: dataQ.py source/dataQ.asm
